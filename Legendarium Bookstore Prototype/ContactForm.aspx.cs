...
namespace Legendarium_Bookstore_Prototype
{
    public partial class ContactForm : System.Web.UI.Page
    {
        ...
        protected void Btnsendemail_Click(object sender, EventArgs e)
        {
            ...
            MailMessage msg = new MailMessage("ak.abdul.alim@gmail.com", "ak.abdul.alim@gmail.com");
            ...
            System.Net.NetworkCredential credentials = new System.Net.NetworkCredential("@gmail.com", "PASSWORD");
            smtpClient.Credentials = credentials;
            //email put two times for it to works
            msg = new MailMessage("ak.abdul.alim@gmail.com", "ak.abdul.alim@gmail.com");
