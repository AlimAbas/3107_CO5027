<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListProduct.aspx.cs" Inherits="Legendarium_Bookstore_Prototype.Admin.EditProduct" %>
    ...
    <form id="form1" runat="server">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="ProductID" DataSourceID="SqlDataSource" OnSelectedIndexChanged="GridView1_SelectedIndexChanged1">
            <Columns>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="ProductID" DataNavigateUrlFormatString="EditProduct.aspx?ProducID={0}" ShowHeader="False" Text="Edit" />
                <asp:HyperLinkField DataNavigateUrlFields="ProductID" DataNavigateUrlFormatString="UploadImage.aspx?field={0}" Text="Upload Image" ShowHeader="False" />
